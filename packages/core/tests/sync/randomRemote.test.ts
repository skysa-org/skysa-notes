...
import { isHidden, isWithin, joinPath, parentPath } from '../../src/paths.js';
...
import type { RemoteEntry, StorageProvider } from '../../src/providers/types.js';
...
/**
 * The three wire stubs, and the fake both ways. The fake and the Dropbox stub
