...
entity. It is for your protection as a Contributor as much as for the Project's.

**This is a licence grant, not an assignment. You keep ownership of everything
you write.**
...
by You to the Project for inclusion in, or documentation of, any of its
products. "Submitted" means any form of electronic, verbal or written
...
to the Project, or that Your employer has executed a separate Corporate CLA
(see [`CLA-entity.md`](CLA-entity.md)).
...
in this agreement restricts You from using, licensing or otherwise exploiting
Your own Contributions however You wish, including under different terms, in
other projects, or commercially.
