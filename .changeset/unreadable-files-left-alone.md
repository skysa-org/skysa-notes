...
damage over the original. Now nothing is imported, no note stays bound to such a
file, and nothing the app sends can land on it. A note with no unsent edits
...
one: a NUL pasted into a note is dropped as the note is saved.
